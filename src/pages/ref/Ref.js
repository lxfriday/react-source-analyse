...
class StringRef extends Component {
  ...
  render() {
    return <div ref="container">StringRefdasdsdasdads</div>
  }
}
...
class CallbackRef extends Component {
  ...
  render() {
    return <div ref={r => (this.container = r)}>CallbackRef</div>
  }
}
...
function ObjectRef(params) {
  ...
  return <div ref={r}>ObjectRef</div>
}
...
class ParentComp extends Component {
  ...
  render() {
    return <ChildComp innerRef={r => (this.inner = r)} />
  }
}
...
function ChildComp({ innerRef }) {
  ...
  return <div ref={r}>ChildComp</div>
}
